    ...
    if (!is_dead) {
        ...
        for (const effect of effects) {
            ...
            if (effect_type == EFFECT.MELEE_ATTACK) {
                ...
                const c_distance = tfm.apply_scale(distance);
                draw_ctx.save();
                draw_ctx.strokeStyle = EFFECT_HAND_ATTACK_COLOR;
