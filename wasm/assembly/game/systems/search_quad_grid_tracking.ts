...
export class SearchQuadGridTrackingSystem extends QuadGridTrackingSystem {
    update(dt: f32): void {
        ...
        for (let i = 0, len = entities.length; i < len; i++) {
            ...
            const quad_index: SearchQuadGridIndexComponent | null = this.get_component<SearchQuadGridIndexComponent>(entity);
