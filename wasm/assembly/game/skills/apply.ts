...
import { DAMAGE_TYPE, TARGET_ACTION, EPSILON } from "../constants";
        ...
        if (target_position && target_radius) {
            ...
            if (d < damage_distance + target_radius.value()) {
                ...
                if (target_apply_damage) {
                    ...
                    ecs.add_component<ApplyDamageComponent>(target_entity, new ApplyDamageComponent(entity, 0, DAMAGE_TYPE.ULTIMATE, 0.0));
                }
            }
        }
